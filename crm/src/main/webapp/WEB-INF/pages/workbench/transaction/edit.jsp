...
<script type="text/javascript">
	$(function () {
		...
		$("#create-contactSummary").val("${tran.contact_summary}");

		$("#create-nextContactTime").val("${tran.next_contact_time}");
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-expectedDate" value="${tran.expected_date}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-customerName" placeholder="支持自动补全，输入客户不存在则新建" value="${tran.customerName}">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-possibility" value="${possibility}%">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="${tran.activity_id}">
				<input type="text" class="form-control" id="activityName" value="${tran.activityName}" readonly>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="${tran.contacts_id}">
				<input type="text" class="form-control" id="contactsName" value="${tran.contactsName}" readonly>
			</div>
		</div>
